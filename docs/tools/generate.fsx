...
let referenceBinaries = ["FsTfServing.dll"]
// Web site location for the generated documentation
let website = "/FsTfServing"

let githubLink = "http://github.com/Prolucid/FsTfServing"

// Specify more information about your project
let info =
  [ "project-name", "FsTfServing"
    "project-author", "Eugene Tolmachev"
    "project-summary", "F# DSL and runtime for Storm topologies"
    "project-github", githubLink
    "project-nuget", "http://nuget.org/packages/FsTfServing" ]
